...
Gmail steals the pullaway by using it for **one task**, not many. When you think about it, it's use is way different from Facebook-style directory navigation. Gmail turns pullaway tropes into real features.
...
<figure markdown="1">
    ![Ebay login screen](/images/Ebay-Login.png)
</figure>
