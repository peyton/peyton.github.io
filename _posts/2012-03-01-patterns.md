...
<figure markdown="1">
    ![Path pullaway menu]({{ site.cdn }}{{ page.title }}Path-Pullaway.png)
</figure>
...
<figure markdown="1">
    ![Path menu button disappearing]({{ site.cdn }}{{ page.title }}Path-Disappearing.png)
</figure>

### Stealing the pullaway: Gmail ###

<figure markdown="1">
    ![Gmail pullaway]({{ site.cdn }}{{ page.title }}Gmail-Pullaway.png)
</figure>
...
<figure markdown="1">
    ![Ebay login screen]({{ site.cdn }}{{ page.title }}Ebay-Login.png)
</figure>
