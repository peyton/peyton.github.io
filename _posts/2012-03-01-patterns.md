...
* **Path** confuses me. It's identical to the news feed above, except the cover photo is bigger. My name is at the top, but I can't change it from here. Also, this news page shows only my posts but has no way to create new items. It may be Path's name for a profile, but who knows? Since it's also the name of the service, I only go here when I really mean to tap Home.
...
If Facebook's design had never happened, what would the consequences have been? Path might've picked a less confusing interaction flow, perhaps merging Home and Path and placing settings in contextually relevant locations. It turns out their app doesn't need navigation. It's a bad sign when a tool creates the problem it solves.
